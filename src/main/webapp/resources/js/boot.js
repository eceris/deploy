head.load(
    { file: 'resources/libs/jquery/jquery-2.1.3.min.js' },
    { file: 'resources/libs/bootstrap/js/bootstrap.js' },
    { file: 'resources/libs/angular/angular.js' },
    { file: 'resources/libs/angular/angular-routes.js' },
    { file: 'resources/libs/angular/angular-file-upload.js' },
    { file: 'resources/libs/bootstrap/js/ui-bootstrap-tpls-0.12.0.js' },
    { file: 'resources/libs/smart-table/smart-table.min.js' },
    { file: 'resources/js/app.js' },
    
    { file: 'resources/js/services/common.serv.js' },
    { file: 'resources/js/services/user.serv.js' },
